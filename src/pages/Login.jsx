...
const Login = () =>
{
  ...
  const {persist,setPersist,formData,handleChange,loginSubmit,loading} = useMainContext()
    ...
    <section className="h-[93dvh] flex justify-center items-center w-full border">
      <div className="w-full md:w-3/4 lg:w-1/2:2xl:w-1/4 shadow-md border rounded-md py-4 px-8">
        ...
        <div className="my-2 flex justify-between items-center">
          ...
          <Button isLoading={loading} isDisabled={loading} color="primary" onClick={loginSubmit}>Login</Button>
        </div>
        <hr />
        <div className="text-center">
          <p>Want to be a vendor? <Link to="/register" className="text-primary">Register</Link></p>
