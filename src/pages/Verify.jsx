...
const Verify = () =>
{
  const { formData, handleChange, loading,timeInSec,resendOtp,verifyCode } = useMainContext()
    ...
    <section className="h-[93dvh] flex justify-center items-center w-full border">
      <div className="w-full md:w-3/4 lg:w-1/2:2xl:w-1/4 shadow-md border rounded-md py-4 px-8">
        ...
        <div className="my-2 flex justify-end items-center">
          <Button isLoading={loading} isDisabled={loading} color="primary" onClick={verifyCode}>Verify</Button>
        </div>
        <hr />
