...
const Toast = ({message,show,duration,onClose,status}) =>
{
  ...
  const className = status.toLowerCase() === "error" ? `bg-danger text-white transition-opacity duration-300 ease-in-out animate-appearance-in` : status.toLowerCase() === "warning" ? `bg-warning text-white transition-opacity duration-300 ease-in-out animate-appearance-in` : status.toLowerCase() === "info" ? `bg-primary text-white transition-opacity duration-300 ease-in-out animate-appearance-in` : status.toLowerCase() === "success" ? `bg-success text-white transition-opacity duration-300 ease-in-out animate-appearance-in` : `bg-primary text-white transition-opacity duration-300 ease-in-out animate-appearance-in`
