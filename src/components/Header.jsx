import { Avatar, Button, Image, Input, Popover, PopoverContent, PopoverTrigger, useDisclosure } from "@nextui-org/react";
...
const Header = () =>
{
  ...
  return (
    <header>
            ...
            <Popover placement="bottom" color="default">
              ...
              <PopoverContent className="w-72">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <Link className="hover:bg-neutral-300 rounded-lg p-2" to="/dispatch">Dispatch Location</Link>
                    <p role="button" className="hover:bg-neutral-300 rounded-lg p-2" onClick={onOpen}>Add location</p>
                  </div>
                  <hr className="my-2 border" />
                  { user.name ? (
      ...
      <AddLocation isOpen={ isOpen }  onOpenChange={onOpenChange}/>
    </header>
  )
}
